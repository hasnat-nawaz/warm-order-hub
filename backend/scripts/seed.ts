...
const demoUsers = [
  ...
  | { role: "customer"; username: string; password: string; displayName: string }
  | { role: "vendor"; username: string; password: string; displayName: string; vendorId: string }
>;
