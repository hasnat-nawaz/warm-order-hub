...
import { d as Route$6, u as useApp } from "./router-8hUpC1Lu.mjs";
import { f as findUser } from "./users-D1LT2A7q.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { m as motion } from "../_libs/framer-motion.mjs";
import { m as Lock, l as ShieldCheck, U as User, E as EyeOff, n as Eye, A as ArrowRight } from "../_libs/lucide-react.mjs";
...
function LoginPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.main, { initial: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto grid h-14 w-14 place-items-center rounded-2xl bg-foreground text-background shadow-warm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "h-6 w-6", strokeWidth: 2.5 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-5 font-display text-3xl font-bold sm:text-4xl", children: "Sign in" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Enter your credentials to continue." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "mt-8 rounded-3xl border border-border bg-card p-6 shadow-card", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "username", className: "mt-5 block text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "Username" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex items-center gap-2 rounded-xl border border-input bg-background px-3 py-2.5 focus-within:border-primary", children: [
        ...
        }, autoComplete: "username", placeholder: "your username", className: "w-full bg-transparent text-base outline-none" })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex items-center gap-2 rounded-xl border border-input bg-background px-3 py-2.5 focus-within:border-primary", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "password", type: showPwd ? "text" : "password", value: password, onChange: (e) => {
          ...
          if (error) setError(null);
        }, autoComplete: "current-password", placeholder: "••••••••", className: "w-full bg-transparent text-base tracking-wider outline-none" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-8 text-center text-sm text-muted-foreground", children: [
      ...
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/signup", search, className: "font-semibold text-primary hover:underline", children: "Create one" })
    ] }),
