...
const ChefHat = createLucideIcon("chef-hat", __iconNode$F);
...
const ListChecks = createLucideIcon("list-checks", __iconNode$p);
const __iconNode$o = [
...
const PackageCheck = createLucideIcon("package-check", __iconNode$i);
const __iconNode$h = [
  [
    "path",
    {
...
const Radio = createLucideIcon("radio", __iconNode$c);
const __iconNode$b = [
  [
    "path",
